...
class AddWiki extends Maintenance {
	...
	private function createMainClusterSchema( IMaintainableDatabase $dbw, $dbName, $siteGroup ) {
		...
		$dbw->sourceFile( "$IP/extensions/AbuseFilter/db_patches/mysql/tables-generated.sql" );
		...
		$dbw->sourceFile( "$IP/extensions/Linter/sql/mysql/tables-generated.sql" );
		...
		if ( $this->isPrivate( $dbName )
			...
			$dbw->sourceFile( "$IP/extensions/Flow/sql/mysql/tables-generated.sql" );
		}
		...
		if ( $this->isPrivateOrFishbowl( $dbName ) ) {
			...
			$dbw->sourceFile( "$IP/extensions/LoginNotify/sql/mysql/tables-generated.sql" );
		}
